...
class RawWhitelistedNumbersClient:
    ...
    ) -> HttpResponse[ListTestNumbersResponse]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=ListTestNumbersResponse,  # type: ignore
...
class AsyncRawWhitelistedNumbersClient:
    ...
    async def list(
        ...
        *,
        ...
        status: typing.Optional[ListTestNumbersRequestStatus] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[ListTestNumbersResponse]:
        """
        List all whitelisted test numbers with optional filtering and pagination. Results are sorted by creation date, newest first.
