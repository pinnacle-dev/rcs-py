...
class CarrierLaunchesVerification(UniversalBaseModel):
    """
    ...
    aegis: typing_extensions.Annotated[VerificationStatus, FieldMetadata(alias="AEGIS")] = pydantic.Field()
    """
    AEGIS verification status.
    """

    google: typing_extensions.Annotated[VerificationStatus, FieldMetadata(alias="GOOGLE")] = pydantic.Field()
    """
