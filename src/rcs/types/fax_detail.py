...
class FaxDetail(UniversalBaseModel):
    id: str
    ...
    """
    One-hour signed URL for the archived document, or null until media is available. Treat the URL as sensitive because anyone who possesses it can access the document until it expires; request this endpoint again for a fresh URL.
    """
