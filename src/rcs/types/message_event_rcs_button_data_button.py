...
class MessageEventRcsButtonDataButton(UniversalBaseModel):
    """
    Information about the button that was clicked.
    """

    type: typing.Optional[MessageEventRcsButtonDataButtonType] = pydantic.Field(default=None)
    """
    ...
    raw: MessageEventRcsButtonDataButtonRaw = pydantic.Field()
    """
